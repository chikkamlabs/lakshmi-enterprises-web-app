...
import { addStaffMember } from '@/lib/staffStore';
import {
  UserPlus,
  ArrowLeft,
  Loader2,
...
export default function AddStaffPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (created) {
        setSuccess(`Staff member "${created.name}" created successfully! Redirecting...`);
        setTimeout(() => {
        ...
        <main className="flex-1 p-4 sm:p-6 md:p-8 max-w-3xl w-full mx-auto space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-500 mt-0.5">
                Register a new staff account with system login credentials.
              </p>
            </div>
          </div>
          ...
          <div className="p-4 bg-amber-50 border border-amber-200 rounded-xl flex items-start gap-3 shadow-xs text-amber-900">
            ...
            <div className="text-xs sm:text-sm">
              ...
              <p className="mt-0.5 font-medium">
                Please remember email &amp; password. Use for login in the Staff portal.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-xs overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5 text-xs sm:text-sm">
              {/* Full Name */}
              <div>
                <label htmlFor="staffName" className="form-label font-semibold text-slate-700 block mb-1">
              ...
              {/* Mobile Number */}
              <div>
                <label htmlFor="staffMobile" className="form-label font-semibold text-slate-700 block mb-1">
              ...
              <div>
                <label htmlFor="staffEmail" className="form-label font-semibold text-slate-700 block mb-1">
              ...
              {/* Password */}
              <div>
                <label htmlFor="staffPassword" className="form-label font-semibold text-slate-700 block mb-1">
                ...
                <p className="text-[11px] text-slate-400 mt-1">
                  This password will allow the staff member to sign into their staff portal.
                </p>
              </div>
